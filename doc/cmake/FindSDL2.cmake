...
MACRO(do_find_package mode)
	IF( NOT ${mode}_FIND_COMPONENTS)
		...
		dp_find_package(${mode} ${mode} SDL.h)
	ELSE()
		FOREACH(cmpt_item ${${mode}_FIND_COMPONENTS})
			IF		(cmpt_item STREQUAL ${mode})
				dp_find_package(${mode} ${cmpt_item} SDL.h)
			ELSEIF	(cmpt_item STREQUAL "main")
				dp_find_package(${mode} ${cmpt_item} SDL_${cmpt_item}.h)	
			ELSEIF	(cmpt_item STREQUAL "test")
				dp_find_package(${mode} ${cmpt_item} SDL_${cmpt_item}.h)				
			ELSE()
